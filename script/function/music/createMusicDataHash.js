...
// 動物の画像・横幅・縦幅を取得できるハッシュテーブル
var animalsData			= new Array();

var createMusicDataHash = function() {
	// scaleToSoundの中身の定義
	scaleToSound["C5"]		= PIANO_C5;
	scaleToSound["B4"]		= PIANO_B4;
	scaleToSound["A4"]		= PIANO_A4;
	scaleToSound["G4"]		= PIANO_G4;
	scaleToSound["F4"]		= PIANO_F4;
	scaleToSound["E4"]		= PIANO_E4;
	scaleToSound["D4"]		= PIANO_D4;
	scaleToSound["C4"]		= PIANO_C4;
