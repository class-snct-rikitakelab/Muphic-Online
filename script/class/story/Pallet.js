var Pallet = enchant.Class.create(enchant.Sprite, {
	...
	_createManPropertyButton : function() {
		var path = STORY_PALLETPROPERTY_MAN_ON._path;
		var width = STORY_PALLETPROPERTY_MAN_ON._width;
		var height = STORY_PALLETPROPERTY_MAN_ON._height;
	...
	_createLadyPropertyButton : function() {
		var path = STORY_PALLETPROPERTY_LADY_OFF._path;
		var width = STORY_PALLETPROPERTY_LADY_OFF._width;
		var height = STORY_PALLETPROPERTY_LADY_OFF._height;
	...
	_createBoyPropertyButton : function() {
		var path = STORY_PALLETPROPERTY_BOY_OFF._path;
		var width = STORY_PALLETPROPERTY_BOY_OFF._width;
		var height = STORY_PALLETPROPERTY_BOY_OFF._height;
	...
	_createGirlPropertyButton : function() {
		var path = STORY_PALLETPROPERTY_GIRL_OFF._path;
		var width = STORY_PALLETPROPERTY_GIRL_OFF._width;
		var height = STORY_PALLETPROPERTY_GIRL_OFF._height;
	...
	// ボタンの押下状態に応じて画像の一覧を表示するメソッド
	_showImage : function() {
		if(this._manPropertyButton._isPush === true) {
			this._showManImage();
		} else if(this._ladyPropertyButton._isPush === true) {
			this._showLadyImage();
		} else if(this._boyPropertyButton._isPush === true) {
			this._showBoyImage();
		} else if(this._girlPropertyButton._isPush === true) {
			this._showGirlImage();
		}
	},

	// お兄さんの画像を一覧表示するメソッド
	_showManImage : function() {
		// 画像4種類表示
		// 「喜」の画像表示
		this._images[0].image = core.assets[STORY_PREVIEWOBJECT_MAN_FRONT_GLAD._path];
		this._images[1].image = core.assets[STORY_PREVIEWOBJECT_MAN_BACK._path];
		this._images[2].image = core.assets[STORY_PREVIEWOBJECT_MAN_RIGHT_GLAD._path];
		this._images[3].image = core.assets[STORY_PREVIEWOBJECT_MAN_LEFT_GLAD._path];
		// 「怒」の画像表示
		this._images[4].image = core.assets[STORY_PREVIEWOBJECT_MAN_FRONT_ANGRY._path];
		this._images[5].image = core.assets[STORY_PREVIEWOBJECT_MAN_BACK._path];
		this._images[6].image = core.assets[STORY_PREVIEWOBJECT_MAN_RIGHT_ANGRY._path];
		this._images[7].image = core.assets[STORY_PREVIEWOBJECT_MAN_LEFT_ANGRY._path];
		// 「哀」の画像表示
		this._images[8].image = core.assets[STORY_PREVIEWOBJECT_MAN_FRONT_SAD._path];
		this._images[9].image = core.assets[STORY_PREVIEWOBJECT_MAN_BACK._path];
		this._images[10].image = core.assets[STORY_PREVIEWOBJECT_MAN_RIGHT_SAD._path];
		this._images[11].image = core.assets[STORY_PREVIEWOBJECT_MAN_LEFT_SAD._path];
		// 「楽」の画像表示
		this._images[12].image = core.assets[STORY_PREVIEWOBJECT_MAN_FRONT_ENJOY._path];
		this._images[13].image = core.assets[STORY_PREVIEWOBJECT_MAN_BACK._path];
		this._images[14].image = core.assets[STORY_PREVIEWOBJECT_MAN_RIGHT_ENJOY._path];
		this._images[15].image = core.assets[STORY_PREVIEWOBJECT_MAN_LEFT_ENJOY._path];
	},
	// お姉さんの画像を一覧表示するメソッド
	_showLadyImage : function() {
		// 画像4種類表示
		// 「喜」の画像表示
		this._images[0].image = core.assets[STORY_PREVIEWOBJECT_LADY_FRONT_GLAD._path];
		this._images[1].image = core.assets[STORY_PREVIEWOBJECT_LADY_BACK._path];
		this._images[2].image = core.assets[STORY_PREVIEWOBJECT_LADY_RIGHT_GLAD._path];
		this._images[3].image = core.assets[STORY_PREVIEWOBJECT_LADY_LEFT_GLAD._path];
		// 「怒」の画像表示
		this._images[4].image = core.assets[STORY_PREVIEWOBJECT_LADY_FRONT_ANGRY._path];
		this._images[5].image = core.assets[STORY_PREVIEWOBJECT_LADY_BACK._path];
		this._images[6].image = core.assets[STORY_PREVIEWOBJECT_LADY_RIGHT_ANGRY._path];
		this._images[7].image = core.assets[STORY_PREVIEWOBJECT_LADY_LEFT_ANGRY._path];
		// 「哀」の画像表示
		this._images[8].image = core.assets[STORY_PREVIEWOBJECT_LADY_FRONT_SAD._path];
		this._images[9].image = core.assets[STORY_PREVIEWOBJECT_LADY_BACK._path];
		this._images[10].image = core.assets[STORY_PREVIEWOBJECT_LADY_RIGHT_SAD._path];
		this._images[11].image = core.assets[STORY_PREVIEWOBJECT_LADY_LEFT_SAD._path];
		// 「楽」の画像表示
		this._images[12].image = core.assets[STORY_PREVIEWOBJECT_LADY_FRONT_ENJOY._path];
		this._images[13].image = core.assets[STORY_PREVIEWOBJECT_LADY_BACK._path];
		this._images[14].image = core.assets[STORY_PREVIEWOBJECT_LADY_RIGHT_ENJOY._path];
		this._images[15].image = core.assets[STORY_PREVIEWOBJECT_LADY_LEFT_ENJOY._path];
	},
	// 男の子の画像を一覧表示するメソッド
	_showBoyImage : function() {
		// 画像4種類表示
		// 「喜」の画像表示
		this._images[0].image = core.assets[STORY_PREVIEWOBJECT_BOY_FRONT_GLAD._path];
		this._images[1].image = core.assets[STORY_PREVIEWOBJECT_BOY_BACK._path];
		this._images[2].image = core.assets[STORY_PREVIEWOBJECT_BOY_RIGHT_GLAD._path];
		this._images[3].image = core.assets[STORY_PREVIEWOBJECT_BOY_LEFT_GLAD._path];
		// 「怒」の画像表示
		this._images[4].image = core.assets[STORY_PREVIEWOBJECT_BOY_FRONT_ANGRY._path];
		this._images[5].image = core.assets[STORY_PREVIEWOBJECT_BOY_BACK._path];
		this._images[6].image = core.assets[STORY_PREVIEWOBJECT_BOY_RIGHT_ANGRY._path];
		this._images[7].image = core.assets[STORY_PREVIEWOBJECT_BOY_LEFT_ANGRY._path];
		// 「哀」の画像表示
		this._images[8].image = core.assets[STORY_PREVIEWOBJECT_BOY_FRONT_SAD._path];
		this._images[9].image = core.assets[STORY_PREVIEWOBJECT_BOY_BACK._path];
		this._images[10].image = core.assets[STORY_PREVIEWOBJECT_BOY_RIGHT_SAD._path];
		this._images[11].image = core.assets[STORY_PREVIEWOBJECT_BOY_LEFT_SAD._path];
		// 「楽」の画像表示
		this._images[12].image = core.assets[STORY_PREVIEWOBJECT_BOY_FRONT_ENJOY._path];
		this._images[13].image = core.assets[STORY_PREVIEWOBJECT_BOY_BACK._path];
		this._images[14].image = core.assets[STORY_PREVIEWOBJECT_BOY_RIGHT_ENJOY._path];
		this._images[15].image = core.assets[STORY_PREVIEWOBJECT_BOY_LEFT_ENJOY._path];
	},
	// 女の子の画像を一覧表示するメソッド
	_showGirlImage : function() {
		// 画像4種類表示
		// 「喜」の画像表示
		this._images[0].image = core.assets[STORY_PREVIEWOBJECT_GIRL_FRONT_GLAD._path];
		this._images[1].image = core.assets[STORY_PREVIEWOBJECT_GIRL_BACK._path];
		this._images[2].image = core.assets[STORY_PREVIEWOBJECT_GIRL_RIGHT_GLAD._path];
		this._images[3].image = core.assets[STORY_PREVIEWOBJECT_GIRL_LEFT_GLAD._path];
		// 「怒」の画像表示
		this._images[4].image = core.assets[STORY_PREVIEWOBJECT_GIRL_FRONT_ANGRY._path];
		this._images[5].image = core.assets[STORY_PREVIEWOBJECT_GIRL_BACK._path];
		this._images[6].image = core.assets[STORY_PREVIEWOBJECT_GIRL_RIGHT_ANGRY._path];
		this._images[7].image = core.assets[STORY_PREVIEWOBJECT_GIRL_LEFT_ANGRY._path];
		// 「哀」の画像表示
		this._images[8].image = core.assets[STORY_PREVIEWOBJECT_GIRL_FRONT_SAD._path];
		this._images[9].image = core.assets[STORY_PREVIEWOBJECT_GIRL_BACK._path];
		this._images[10].image = core.assets[STORY_PREVIEWOBJECT_GIRL_RIGHT_SAD._path];
		this._images[11].image = core.assets[STORY_PREVIEWOBJECT_GIRL_LEFT_SAD._path];
		// 「楽」の画像表示
		this._images[12].image = core.assets[STORY_PREVIEWOBJECT_GIRL_FRONT_ENJOY._path];
		this._images[13].image = core.assets[STORY_PREVIEWOBJECT_GIRL_BACK._path];
		this._images[14].image = core.assets[STORY_PREVIEWOBJECT_GIRL_RIGHT_ENJOY._path];
		this._images[15].image = core.assets[STORY_PREVIEWOBJECT_GIRL_LEFT_ENJOY._path];
	},
})