var BackgroundPropertyButton =  enchant.Class.create(enchant.Group, {
	...
	_createDogPropertyButton : function() {
		...
		var x = (APP_WIDTH - STORY_BACKGROUNDPALETTE._width) / 2 + 300;
		var y = (APP_HEIGHT - STORY_BACKGROUNDPALETTE._height) / 2 + 30;
	...
	_createCloudPropertyButton : function() {
		...
		var x = (APP_WIDTH - STORY_BACKGROUNDPALETTE._width) / 2 + 300 + 166;
		var y = (APP_HEIGHT - STORY_BACKGROUNDPALETTE._height) / 2 + 30;
