var BackgroundPalette = enchant.Class.create(enchant.Group, {
	...
	_createPaletteFrame : function() {
		var path = STORY_BACKGROUNDPALETTE._path;
		var width = STORY_BACKGROUNDPALETTE._width;
		var height = STORY_BACKGROUNDPALETTE._height;
	...
	_createCloseButton : function() {
		...
		var x = (APP_WIDTH - STORY_BACKGROUNDPALETTE._width) / 2 + STORY_BACKGROUNDPALETTE._width - 120;
		var y = (APP_HEIGHT - STORY_BACKGROUNDPALETTE._height) / 2 + STORY_BACKGROUNDPALETTE._height - 70;
