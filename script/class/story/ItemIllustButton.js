var ItemIllustButton = enchant.Class.create(enchant.Sprite, {
	...
	ontouchend : function(event) {
		...
		if((humanPush === true || animalPush === true || backgroundPush === true) && itemPush === false) {
			if(humanPush === true) {
