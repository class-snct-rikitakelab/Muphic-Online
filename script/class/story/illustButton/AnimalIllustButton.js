var AnimalIllustButton = enchant.Class.create(enchant.Sprite, {
	...
	_setDarkImage : function(isDark) {
		if(isDark === true) {
			this.image = core.assets[STORY_ANIMAL_ILLUSTBUTTON_DARK._path];
		} else if(isDark === false) {
			this.image = core.assets[STORY_ANIMAL_ILLUSTBUTTON._path];
		}
	},
	...
	// クリック時の処理
	ontouchend : function() {
		this._parent._paletteMakeRequest("animal");
	},
})