var MeasureNext = Class.create(MySprite, {
	...
	onenterframe : function(e) {
		if(this.scene.left_measure === MEASURE_MAX - 2) {
			this._touchDisable();
		} else if(this.scene.left_measure < MEASURE_MAX - 2 && this.scene.start.state === "stop") {
			this._touchEnable();
		}
