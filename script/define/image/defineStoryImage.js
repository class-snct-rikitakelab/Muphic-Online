...
var STORY_SAVEBUTTON_OFF;
var STORY_SAVEBUTTON_ON;
var STORY_LOADBUTTON_OFF;
var STORY_LOADBUTTON_ON;
...
var STORY_SAVEBUTTON_DARK;
var STORY_LOADBUTTON_DARK;
...
var defineStoryImage = function() {
	...
	STORY_SAVEBUTTON_OFF = new NormalImage("../image/story/button/saveButtonOff.png", 120, 70);
	STORY_SAVEBUTTON_ON = new NormalImage("../image/story/button/saveButtonOn.png", 120, 70);
	STORY_LOADBUTTON_OFF = new NormalImage("../image/story/button/loadButtonOff.png", 120, 70);
	STORY_LOADBUTTON_ON = new NormalImage("../image/story/button/loadButtonOn.png", 120, 70);
	...
	STORY_SAVEBUTTON_DARK = new NormalImage("../image/story/button/saveButtonDark.png", 120, 70);
	STORY_LOADBUTTON_DARK = new NormalImage("../image/story/button/loadButtonDark.png", 120, 70);
