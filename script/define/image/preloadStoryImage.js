var preloadStoryImage = function() {
	...
	core.preload(STORY_PALLET._path);
	core.preload(STORY_PALLETILLUST_HUMAN._path);
	core.preload(STORY_PALLETPROPERTY_MAN_OFF._path);
	core.preload(STORY_PALLETPROPERTY_MAN_ON._path);
	core.preload(STORY_PALLETPROPERTY_LADY_OFF._path);
	core.preload(STORY_PALLETPROPERTY_LADY_ON._path);
	core.preload(STORY_PALLETPROPERTY_BOY_OFF._path);
	core.preload(STORY_PALLETPROPERTY_BOY_ON._path);
	core.preload(STORY_PALLETPROPERTY_GIRL_OFF._path);
	core.preload(STORY_PALLETPROPERTY_GIRL_ON._path);
	core.preload(STORY_PALLETFACE_MAN_GLAD._path);
	core.preload(STORY_PALLETFACE_MAN_ANGRY._path);
	core.preload(STORY_PALLETFACE_MAN_SAD._path);
	core.preload(STORY_PALLETFACE_MAN_ENJOY._path);
	core.preload(STORY_PALLETFACE_LADY_GLAD._path);
	core.preload(STORY_PALLETFACE_LADY_ANGRY._path);
	core.preload(STORY_PALLETFACE_LADY_SAD._path);
	core.preload(STORY_PALLETFACE_LADY_ENJOY._path);
	core.preload(STORY_PALLETFACE_BOY_GLAD._path);
	core.preload(STORY_PALLETFACE_BOY_ANGRY._path);
	core.preload(STORY_PALLETFACE_BOY_SAD._path);
	core.preload(STORY_PALLETFACE_BOY_ENJOY._path);
	core.preload(STORY_PALLETFACE_GIRL_GLAD._path);
	core.preload(STORY_PALLETFACE_GIRL_ANGRY._path);
	core.preload(STORY_PALLETFACE_GIRL_SAD._path);
	core.preload(STORY_PALLETFACE_GIRL_ENJOY._path);
}