...
var MUSIC_SAVEBUTTON_OFF;
var MUSIC_SAVEBUTTON_ON;
var MUSIC_LOADBUTTON_OFF;
var MUSIC_LOADBUTTON_ON;
var MUSIC_HUMEN;
...
var MUSIC_SAVEBUTTON_DARK;
var MUSIC_LOADBUTTON_DARK;
...
var defineMusicImage = function() {
	...
	MUSIC_SAVEBUTTON_OFF = new NormalImage("../image/music/button/saveButtonOff.png", 120, 70);
	MUSIC_SAVEBUTTON_ON = new NormalImage("../image/music/button/saveButtonOn.png", 120, 70);
	MUSIC_LOADBUTTON_OFF = new NormalImage("../image/music/button/loadButtonOff.png", 120, 70);
	MUSIC_LOADBUTTON_ON = new NormalImage("../image/music/button/loadButtonOn.png", 120, 70);
	...
	MUSIC_SAVEBUTTON_DARK = new NormalImage("../image/music/button/saveButtonDark.png", 120, 70);
	MUSIC_LOADBUTTON_DARK = new NormalImage("../image/music/button/loadButtonDark.png", 120, 70);
